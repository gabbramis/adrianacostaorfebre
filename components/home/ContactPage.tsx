...
import { MapPin, Phone, Mail, Clock, Instagram, Facebook, MessageCircle, Send, CheckCircle2, Gem, Heart, Award } from 'lucide-react'
  ...
  const faqs = [
    {
      ...
      answer: "Sí, nos especializamos en crear piezas únicas según tus ideas y preferencias. El proceso incluye una consulta inicial, diseño, aprobación y elaboración de la pieza."
    },
    {
      question: "¿Cuánto tiempo toma hacer una pieza personalizada?",
      answer: "Dependiendo de la complejidad, una pieza personalizada puede tomar entre 2 a 4 semanas. Te mantendremos informado durante todo el proceso."
    },
    {
      question: "¿Qué materiales utilizan?",
      answer: "Trabajamos principalmente con plata 925, oro 18k y piedras naturales seleccionadas. Todos nuestros materiales son de alta calidad y certificados."
    },
    {
      question: "¿Ofrecen garantía en sus productos?",
      answer: "Sí, todas nuestras piezas tienen garantía de 6 meses contra defectos de fabricación. También ofrecemos servicio de mantenimiento y reparación."
    },
    {
      question: "¿Realizan envíos a todo Uruguay?",
      answer: "Sí, realizamos envíos a todo el país. Los envíos a Montevideo son gratuitos en compras superiores a $2000. Para el interior, consultanos las tarifas."
    },
    {
      question: "¿Puedo ver las piezas antes de comprar?",
      answer: "Por supuesto. Podés agendar una cita en nuestro taller para ver las piezas en persona y conocer nuestro proceso de trabajo."
    }
  ]
  ...
  const services = [
    {
      ...
      description: "Creamos piezas únicas basadas en tus ideas y preferencias personales."
    },
    {
      icon: Heart,
      title: "Reparación y Restauración",
      description: "Damos nueva vida a tus joyas favoritas con técnicas especializadas."
    },
    {
      icon: Award,
      title: "Asesoramiento Especializado",
      description: "Te ayudamos a elegir la pieza perfecta para cada ocasión especial."
    }
  ]
    ...
    <>
      <main className="pt-0">
        ...
        <section className="bg-stone-800 text-white py-16">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg md:text-xl max-w-3xl mx-auto text-stone-300">
              Estamos aquí para ayudarte a encontrar la pieza perfecta o crear algo único especialmente para ti.
            </p>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-serif mb-6">Envíanos un Mensaje</h2>
              ...
              <div>
                <h2 className="text-2xl md:text-3xl font-serif mb-6">Información de Contacto</h2>
        ...
        <section className="py-16 bg-stone-50">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-serif text-center mb-12">Nuestros Servicios</h2>
        ...
        */}
        ...
        <section className="py-16 bg-stone-800 text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl md:text-3xl font-serif mb-4">¿Listo para Crear Algo Único?</h2>
            <p className="text-lg max-w-2xl mx-auto mb-8 text-stone-300">
              Ya sea que tengas una idea específica o necesites inspiración, estamos aquí para ayudarte a crear la pieza perfecta.
            </p>
