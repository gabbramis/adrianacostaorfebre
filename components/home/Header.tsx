          ...
          >
            {NAV_LINKS.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className={`text-sm font-medium transition-colors hover:text-stone-600 dark:hover:text-stone-300 ${pathname === link.href
            ...
            <div className="relative">
              <form onSubmit={handleSearch} className="flex items-center">
                <Input
                  ...
                  className={`transition-all duration-300 border-stone-300 focus:border-stone-500 focus:ring-stone-500 ${isSearchOpen
                      ? "w-[200px] opacity-100"
